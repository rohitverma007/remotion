...
### `playBackRate`<AvailableFrom v="3.3.4" />

The playback rate of the GIF. Can be a number greater than 0. A higher number will make the GIF play faster, a lower number will make it play slower.
